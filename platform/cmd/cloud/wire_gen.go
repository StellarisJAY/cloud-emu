...
func wireApp(confServer *conf.Server, confData *conf.Data, auth *conf.Auth, registry *conf.Registry, logger log.Logger) (*kratos.App, func(), error) {
	...
	roomUseCase := biz.NewRoomUseCase(roomRepo, node, userRepo, transaction, roomMemberRepo, redsync, logger)
	...
	roomInstanceUseCase := biz.NewRoomInstanceUseCase(roomInstanceRepo, node, redsync, gameServerRepo, roomRepo, roomMemberRepo, transaction, logger)
