...
export default {
  ...
  methods: {
    listKeyboardBindings: function () {
      ...
      api.get("/keyboard/bindings?page=0&pageSize=100").then(resp => {
    ...
    deleteBinding: function () {
      ...
      api.delete("/keyboard/binding/" + this.selectedKey).then(_ => {
    ...
    createBinding: function () {
      ...
      this.bindingBtnDisable = true;
      api.post("/keyboard/binding", data).then(_ => {
    ...
    updateBinding: function () {
      ...
      this.createBtnDisable = true;
      this.bindingBtnDisable = true;
      api.put("/keyboard/binding", data).then(_ => {
